    ...
    <>
      <Head>
        <link
          type="text/css"
          rel="stylesheet"
          href="https://codex.nflxext.com/%5E3.0.0/truthBundle/webui/1.22.5-shakti-css-vafe38bd5/css/css/less%7Clogin%7CloginBase.less,less%7Cpages%7Clogin%7CLogin.less/1/btzvF4DugayCE/none/true/none"
          data-uia="botLink"
        />
        <title>Netflix</title>
      </Head>
      <div className="login-wrapper hybrid-login-wrapper">
        ...
        <div className="nfHeader login-header signupBasicHeader">
          <Link href="/">
            <a className="svg-nfLogo signupBasicHeader">
              <svg
                viewBox="0 0 111 30"
          ...
          <div className="login-content login-form hybrid-login-form hybrid-login-form-signup">
            <div className="hybrid-login-form-main">
              ...
              <form className="login-form">
                <div className="nfInput nfEmailPhoneInput nfEmailPhoneInError login-input login-input-email">
                    ...
                    <div className="nfEmailPhoneControls">
                      <label className="input_id" placeholder="">
                        <input
                          ...
                          dir=""
                        />
                        <label htmlFor="id_userLoginId" className="placeLabel">
                ...
                <div
                  ...
                  className="nfInput nfPasswordInput nfPasswordInError login-input login-input-password"
                >
                  <div className="nfInputPlacement">
